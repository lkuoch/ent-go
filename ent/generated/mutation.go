...
func withRemoteID(id types.ID) remoteOption {
...
// operation is only accepted on creation of Remote entities.
func (m *RemoteMutation) SetID(id types.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *RemoteMutation) ID() (id types.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *RemoteMutation) IDs(ctx context.Context) ([]types.ID, error) {
	switch {
...
func (m *RemoteMutation) SetData(s string) {
	m.data = &s
}

// Data returns the value of the "data" field in the mutation.
func (m *RemoteMutation) Data() (r string, exists bool) {
	v := m.data
	if v == nil {
		return
	}
...
// OldData returns the old "data" field's value of the Remote entity.
// If the Remote object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RemoteMutation) OldData(ctx context.Context) (v string, err error) {
...
func (m *RemoteMutation) ResetData() {
	m.data = nil
}
...
func (m *RemoteMutation) Fields() []string {
	...
	if m.data != nil {
		fields = append(fields, remote.FieldData)
	}
	return fields
}
