...
type TodoWhereInput struct {
	...
	TimeCompletedNEQ    *time.Time  `json:"timeCompletedNEQ,omitempty"`
	TimeCompletedIn     []time.Time `json:"timeCompletedIn,omitempty"`
	TimeCompletedNotIn  []time.Time `json:"timeCompletedNotIn,omitempty"`
	TimeCompletedGT     *time.Time  `json:"timeCompletedGT,omitempty"`
	TimeCompletedGTE    *time.Time  `json:"timeCompletedGTE,omitempty"`
	TimeCompletedLT     *time.Time  `json:"timeCompletedLT,omitempty"`
	TimeCompletedLTE    *time.Time  `json:"timeCompletedLTE,omitempty"`
...
func (i *TodoWhereInput) P() (predicate.Todo, error) {
	...
	if i.TimeCompletedNEQ != nil {
		predicates = append(predicates, todo.TimeCompletedNEQ(*i.TimeCompletedNEQ))
	}
	if len(i.TimeCompletedIn) > 0 {
		predicates = append(predicates, todo.TimeCompletedIn(i.TimeCompletedIn...))
	}
	if len(i.TimeCompletedNotIn) > 0 {
		predicates = append(predicates, todo.TimeCompletedNotIn(i.TimeCompletedNotIn...))
	}
	if i.TimeCompletedGT != nil {
		predicates = append(predicates, todo.TimeCompletedGT(*i.TimeCompletedGT))
	}
	if i.TimeCompletedGTE != nil {
		predicates = append(predicates, todo.TimeCompletedGTE(*i.TimeCompletedGTE))
	}
	if i.TimeCompletedLT != nil {
		predicates = append(predicates, todo.TimeCompletedLT(*i.TimeCompletedLT))
	}
	if i.TimeCompletedLTE != nil {
		predicates = append(predicates, todo.TimeCompletedLTE(*i.TimeCompletedLTE))
	}
	if i.TimeCompletedIsNil {
		predicates = append(predicates, todo.TimeCompletedIsNil())
	}
	if i.TimeCompletedNotNil {
