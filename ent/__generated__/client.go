...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	if _, ok := c.driver.(*txDriver); ok {
		return nil, errors.New("__generated__: cannot start a transaction within a transaction")
	}
	tx, err := newTx(ctx, c.driver)
	if err != nil {
		return nil, fmt.Errorf("__generated__: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("__generated__: unknown mutation type %T", m)
	}
}
...
func (c *TodoClient) mutate(ctx context.Context, m *TodoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("__generated__: unknown Todo mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("__generated__: unknown User mutation op: %q", m.Op())
	}
}
